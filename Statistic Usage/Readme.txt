...
inside this one there are another two options, one of them 
reverse a given string and the other one put a given string
into a given format. Finally there is the last option "Show
Use Statistics" that shows how many times every option was
used.
